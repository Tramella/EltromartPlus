...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('main') }}" target="_blank">
                <img src="{{ asset('images/Logo_small.png') }}" class="navbar-brand-img h-100 rounded-circle"
                    alt="main_logo">
                <span class="ms-2 font-weight-bold">Eltromart +</span>
            </a>
        </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <form method="post" action="{{ route('logout') }}">
                        ...
                        <button type="submit"><span class="nav-link-text ms-1">Logout</span></button>
                    </form>
                </li>
            </ul>
        </div>
            ...
            <div class="container-fluid py-1 px-3">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item d-flex align-items-center">
                            <a href="{{ route('main') }}" class="nav-link text-body font-weight-bold px-0">
                                <i class="fa fa-user me-sm-1"></i>
                                <span class="d-sm-inline d-none">Back to page</span>
                            </a>
                        </li>
